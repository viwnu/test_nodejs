...
// удалить лишние консоль логи
// ввести геттеры и сеттеры
// this.indexses мб вывести в отдельный объект, хотя.. смысл?

// забросить в конструктор все нужные переменные
// проверить на переиспользование части кода

// понять как запустить демон как часть основного expressApp.js (мб через роуты как то,
// типа демон должен запуститься при запуске приложения)
// пример для гугления: как в экспресс джи эс сделать чтоб в консоль выводилось каждые 10 секунд
